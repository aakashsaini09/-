        ...
        <div className="project-section">
          <div className="project-container" data-aos="zoom-in-up">
           ...
           <div className="project-container" data-aos="zoom-in-up">
            ...
            <div className="paragraph">
              Crypto tracking application that offers price updates & one-year data trends. Developed with React/TypeScript, Chart API, TailWind-CSS and more.<br /><br /><span>Tech Stack: </span>TYPESCRIPT, REACT-JS, TAILWIND-CSS.
              </div>
            <div className="icons" >
              <div className="icon">
